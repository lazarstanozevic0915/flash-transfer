            ...
            </div>
            {
                activePage === 'how-to' && (
                    <div className="pl-32 max-sm:pl-4 pr-48 max-sm:pr-4 py-12 w-full space-y-4">
                        ...
                        <p className="text-[#6E757D] dm-sans-light max-w-[70%] mb-8 text-[14px] text-left max-sm:max-w-full">
                        ...
                        <p className='text-[#181F30] dm-sans-semibold text-[14px] w-[40%] max-sm:w-full text-left mb-8'>
                    ...
                    <div className='px-32 max-sm:px-2 max-sm:pt-8 pb-20 w-full'>
                        <div className="w-full h-full flex max-md:flex-col-reverse justify-between items-center">
                            ...
                            <div className='rounded-4xl'>
                                <img src={complaintsBackImg} alt="" className='w-[600px] max-sm:w-[400px] h-[400px]' />
                            </div>
                        </div>
                    </div>
                )

    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <main className=" mx-auto px-0">
                    <div className="flex flex-col mb-28 relative bg-gray-100 px-30 py-24 rounded-b-2xl max-md:px-4 max-md:py-14">
                        ...
                        <div className="text-left">
                            <h1 className="text-5xl font-bold mb-6 max-md:text-3xl max-md:mb-4">Beneficiary</h1>
                            <p className="text-gray-600 text-[16px] max-md:mb-4">
                                Find the full list of your beneficiaries here. You can add a new or delete a beneficiary.
                            </p>
                        </div>
                        <button className="px-6 py-2.5 bg-[#0066FF] text-white rounded-lg flex items-center gap-2 text-lg max-md:w-full z-50">
                            <img src={addben} alt="user" className='object-contain' />
                            Add new beneficiary
                        </button>
                        </div>
        
                        <hr className='border border-[#D3D8DD] mb-6 -mt-2 z-50' />
                        ...
                        />
                        <img src={search} alt="search" className="absolute z-10 left-4 top-1/2 transform text-lg -translate-y-1/2 h-5 w-5 text-gray-800 object-contain" />
                    </div>
                    <div className='md:hidden bg-white p-2 w-10 h-13.5 rounded-lg flex justify-center items-center z-50'>
                    <img src={icons.filter} alt="filter" className='object-contain h-5'/>
                    </div>
                    </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mx-32 mb-22 max-md:flex max-md:flex-col max-md:mx-4">
                        {beneficiaries.map((beneficiary, index) => (
                            <div key={index} className="flex items-center justify-between p-4 bg-[#F6F6F6] rounded-lg border border-gray-100 hover:shadow-md transition-shadow max-md:w-full">

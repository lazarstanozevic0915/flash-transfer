    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <main className="relative">
        ...
        <div className="text-center bg-gray-50 pt-16 pb-32 relative">
          <h1 className="text-5xl font-semibold mb-4 max-md:text-3xl">Registration page for merchants</h1>
          <p className="text-gray-600 text-[16px] max-md:hidden">
          Join our merchant community to expand your reach and grow your business with <br /> seamless access to new customers and powerful tools
          </p>
          <p className="text-gray-600 text-[16px] md:hidden">
          Join our merchant community to expand <br /> your reach and grow your business with <br /> seamless access to new customers <br /> and powerful tools
          </p>
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 max-md:bottom-15 max-md:left-35">
            <img src={heroBackground} alt="" className="h-[300px] w-auto max-md:max-w-[400px] object-contain" />
          </div>
        </div>

        {/* Form Section */}
        <div className="max-w-4xl mx-auto -mt-20 px-6 mb-24 relative z-10">
          <div className="bg-white rounded-xl p-8 shadow-lg max-md:p-4">
            <div className="grid grid-cols-2 gap-6 mb-6 max-md:flex max-md:flex-col">
              <div>

      ...
      <View className="bg-white p-5 rounded-xl shadow-lg mt-8 mb-8 mx-4">
        ...
        <View className=" pt-4 space-y-3">
          <View className="flex-row justify-between mb-3">
            <Text className="text-[#6E757D] text-[14px] font-medium">Mobile Money</Text>
            <Image
              source={omoney}
              className="object-fill"
            />
          ...
          <View className="flex-row justify-between mb-6">
            <Text className="text-[#6E757D] text-[14px] font-medium">Phone Number</Text>
            <Text className="text-black font-semibold text-[14px]">+33 255 55 2335 2</Text>
          </View>

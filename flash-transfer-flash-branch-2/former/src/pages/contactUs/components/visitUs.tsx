...
import { socialIcons } from '../../../assets/image';
...
const VisitUsWrapper = styled(GlobalSpacing)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  backgroundColor: theme.palette.common.mainBg,
}));

const VisitUsContainer = styled(Stack)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  gap: theme.spacing(6),
...
const SocialGrid = styled(Stack)(({ theme }) => ({
  display: 'grid',
